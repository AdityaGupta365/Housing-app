...
#         df['bedrooms'] * 200 +
#         df['bathrooms'] * 150 +
#         df['parking_spots'] * 100 +
#         df['furnished'] * 300 +
#         df['amenities_count'] * 50 -
#         df['age_years'] * 10 -
#         df['distance_to_center_km'] * 30
#     )
    
#     # Location multipliers
#     location_multipliers = {
#         'Downtown': 1.4, 'City Center': 1.3,
#         'Suburb': 1.0, 'Outskirts': 0.8
#     }
...
#     # Final price with noise - FIXED: Changed clip(min=500) to clip(500)
#     df['rent_price'] = (base_price * df['location_multiplier'] * df['type_multiplier'] +
#                        np.random.normal(0, 100, n_samples)).clip(500)
